<app>
  ...
  <script>
    ...
    this.getSkill = function(e){
      switch (this.refs.skills.value) {
        case "beginner":
          this.message = "You're still a newbie. Keep working!";
          break;
          case "intermediate":
            this.message = "Good but not there yet. Keep working!";
            break;
            case "advanced":
              this.message = "That's where the money is. You're a real PRO!";
              break;
        default:
